  ...
  async function onSubmit(values: CustomerFormValues) {
    ...
    try {
      ...
      if (isAxiosError(error)) {
        ...
        setServerError("Unable to create customer");
      }
    }
  }
  ...
  return (
    <section className="mx-auto max-w-4xl space-y-6">
      <header>
        ...
        <h1 className="mt-1 text-3xl font-bold text-white">Add customer</h1>

        <p className="mt-2 text-slate-400">
          Create a customer profile for your organization.
        </p>
      </header>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="mt-1 text-sm text-slate-400">
            Required fields are marked by validation when submitted.
          </p>
        </CardHeader>
